...
parser.add_argument("-single",'--single', help="Is the input a single pdb file?", type=int, default=0)
parser.add_argument("-single_name","--single_name", help="Path to single pdb file", type=str)
...
if single==1:
	...
	subprocess.call(['python', mpnn_path+"/protein_mpnn_run.py", '--pdb_path='+single_path,'--pdb_path_chains='+chains, '--num_seq_per_target='+str(seqs), '--out_folder='+output_path, '--fixed_positions_jsonl='+path_for_fixed_positions])
